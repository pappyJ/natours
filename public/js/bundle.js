      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error In Logging Out');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Registration Successful!!! , Proceed To Login');
              window.setTimeout(function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            if (photo) {
              document.querySelector('.nav__user-img').src = "/img/users/".concat(photo);
              document.querySelector('.form__user-photo').src = "/img/users/".concat(photo);
            }
...
var passwordBtn = document.querySelector('.btn--update-password');
